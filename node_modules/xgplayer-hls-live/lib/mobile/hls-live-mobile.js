    ...
    value: function _onDemuxComplete() {
      ...
      if (this._player.video) {
        ...
        videoTrack.samples.forEach(function (sample) {
          ...
          var buffer = new _xgplayerTransmuxerBufferStream2.default(sample.data.buffer);
          var nals = void 0;
          if (_this._isHEVC(videoTrack.meta)) {
            nals = _xgplayerTransmuxerCodecHevc.NalUnitHEVC.getHvccNals(buffer);
          } else {
            nals = _xgplayerTransmuxerCodecAvc.NalUnit.getNalunits(buffer);
          }
