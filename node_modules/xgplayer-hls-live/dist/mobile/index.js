(function (global, factory) {
  ...
  var FetchLoader = function () {
    function FetchLoader(configs) {
      _classCallCheck$4(this, FetchLoader);
  ...
  var M3U8Parser = function () {
    function M3U8Parser() {
      _classCallCheck$6(this, M3U8Parser);
    }

    _createClass$6(M3U8Parser, null, [{
      key: 'parse',
  ...
  var ADTS = function () {
    function ADTS() {
      _classCallCheck$8(this, ADTS);
    }

    _createClass$8(ADTS, null, [{
      key: "isHeader",
  ...
  var AAC = function () {
    function AAC() {
      _classCallCheck$9(this, AAC);
    }

    _createClass$9(AAC, null, [{
      key: 'getSilentFrame',
  ...
  var AudioTrackMeta = function () {
    function AudioTrackMeta(meta) {
      _classCallCheck$k(this, AudioTrackMeta);
  ...
  var VideoTrackMeta = function () {
    function VideoTrackMeta(meta) {
      _classCallCheck$k(this, VideoTrackMeta);
  ...
  var AudioTrackSample = function () {
    function AudioTrackSample(info) {
      _classCallCheck$l(this, AudioTrackSample);
    ...
    _createClass$l(AudioTrackSample, null, [{
      key: "getDefault",
  ...
  var VideoTrackSample = function () {
    function VideoTrackSample(info) {
      _classCallCheck$l(this, VideoTrackSample);
    ...
    _createClass$l(VideoTrackSample, null, [{
      key: "getDefault",
      value: function getDefault() {
        return {
          dts: null,
  ...
  var TsDemuxer = function () {
    function TsDemuxer(configs) {
      _classCallCheck$m(this, TsDemuxer);
  ...
  var Playlist = function () {
    function Playlist(configs) {
      _classCallCheck$n(this, Playlist);
  ...
  var RafTicker = function (_Ticker) {
    ...
    function RafTicker(props) {
      _classCallCheck$p(this, RafTicker);
  ...
  var TimeoutTicker = function (_Ticker2) {
    ...
    function TimeoutTicker(config) {
      _classCallCheck$p(this, TimeoutTicker);
  ...
  var YUVCanvas = function () {
    function YUVCanvas(configs) {
      _classCallCheck$q(this, YUVCanvas);
  ...
  var SourceBuffer = function () {
    function SourceBuffer(config) {
      _classCallCheck$r(this, SourceBuffer);
  ...
  var TimeRanges = function () {
    function TimeRanges(ranges) {
      _classCallCheck$s(this, TimeRanges);

      this.ranges = ranges || [];
    }

    _createClass$s(TimeRanges, [{
      key: "start",
  ...
  var VideoCanvas = function (_EventEmitter) {
    _inherits$3(VideoCanvas, _EventEmitter);

    function VideoCanvas(config) {
      _classCallCheck$t(this, VideoCanvas);

      var _this = _possibleConstructorReturn$3(this, (VideoCanvas.__proto__ || Object.getPrototypeOf(VideoCanvas)).call(this));
  ...
  var AudioCtx = function (_EventEmitter) {
    _inherits$4(AudioCtx, _EventEmitter);

    function AudioCtx(config) {
      _classCallCheck$u(this, AudioCtx);

      var _this2 = _possibleConstructorReturn$4(this, (AudioCtx.__proto__ || Object.getPrototypeOf(AudioCtx)).call(this));
  ...
  var AVReconciler = function () {
    function AVReconciler(props) {
      _classCallCheck$v(this, AVReconciler);
  ...
  var MobileVideo = function (_HTMLElement) {
    ...
    _createClass$w(MobileVideo, null, [{
      key: 'resolveVideoGOP',
    ...
    function MobileVideo() {
      _classCallCheck$w(this, MobileVideo);
  ...
  var HlsLivePlayer = function (_Player) {
    _inherits$6(HlsLivePlayer, _Player);

    _createClass$x(HlsLivePlayer, null, [{
      key: 'isSupported',
      value: function isSupported() {
    ...
    function HlsLivePlayer(options) {
      _classCallCheck$x(this, HlsLivePlayer);

      if (!options.mediaType) {
        options.mediaType = 'mobile-video';
      }

      var _this = _possibleConstructorReturn$6(this, (HlsLivePlayer.__proto__ || Object.getPrototypeOf(HlsLivePlayer)).call(this, options));
    ...
    _createClass$x(HlsLivePlayer, [{
      ...
      value: function start() {
        ...
        _get$2(HlsLivePlayer.prototype.__proto__ || Object.getPrototypeOf(HlsLivePlayer.prototype), 'start', this).call(this, url);
        this._initEvents();
        this.started = true;
      }
    }, {
      ...
      value: function destroy() {
        ...
        return new Promise(function (resolve) {
          _get$2(HlsLivePlayer.prototype.__proto__ || Object.getPrototypeOf(HlsLivePlayer.prototype), 'destroy', _this3).call(_this3);
          var video = _this3.video,
              root = _this3.root;

          _get$2(HlsLivePlayer.prototype.__proto__ || Object.getPrototypeOf(HlsLivePlayer.prototype), 'destroy', _this3).call(_this3, isDelDOM);
