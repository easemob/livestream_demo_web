(function (global, factory) {
  ...
  var HlsLiveController = function () {
    function HlsLiveController(configs) {
      _classCallCheck$4(this, HlsLiveController);
    ...
    _createClass$4(HlsLiveController, [{
      key: 'init',
      value: function init() {
        ...
        var _player$hlsOps = this._player.hlsOps,
            ...
            PreSource = _player$hlsOps.PreSource,
      ...
      value: function initEvents() {
        ...
        this.on(REMUX_EVENTS$1.INIT_SEGMENT, this.mse.addSourceBuffers.bind(this.mse));

        this.on(REMUX_EVENTS$1.MEDIA_SEGMENT, this.mse.doAppend.bind(this.mse));
        ...
        this.on(REMUX_EVENTS$1.REMUX_ERROR, this._onRemuxError.bind(this));

        this.on(MSE_EVENTS$1.MSE_ERROR, this._handleMseError.bind(this));
      }
    }, {
      key: '_onError',
      ...
      value: function _onDemuxComplete() {
        this.emit(REMUX_EVENTS$1.REMUX_MEDIA);
      }
    }, {
      ...
      value: function _onRemuxError(mod, error, fatal) {
        ...
        this._onError(REMUX_EVENTS$1.REMUX_ERROR, mod, error, fatal);
      }
    }, {
      key: '_handleMseError',
        ...
        if (buffer.TAG === 'M3U8_BUFFER') {
          ...
          try {
            ...
            if (result && result[2]) {
              ...
              mdata = this._player.hlsOps.M3U8Parser.parse(this.m3u8Text, this.baseurl);
            }
          } catch (error) {
      ...
      value: function _preload() {
        ...
        if (frag && !frag.downloaded && !frag.downloading) {
          ...
          if ((!frag || frag.downloaded) && (current - this._m3u8lasttime) / 1000 > preloadTime) {
            ...
            this.emitTo('M3U8_LOADER', LOADER_EVENTS$2.LADER_START, this.url, {}, 0);
          }
        }
      }
    }, {
      key: 'load',
      value: function load(url) {
        this.baseurl = this._player.hlsOps.M3U8Parser.parseURL(url);
        this.url = url;
        this._preload();
      }
    }, {
      ...
      value: function destroy() {
        ...
        this.off(REMUX_EVENTS$1.INIT_SEGMENT, this.mse.addSourceBuffers);
        this.off(REMUX_EVENTS$1.MEDIA_SEGMENT, this.mse.doAppend);
  ...
  var MSE = function () {
    ...
    _createClass$5(MSE, [{
      ...
      value: function onUpdateEnd() {
        this.emit(MSE_EVENTS$2.SOURCE_UPDATE_END);
        this.doAppend();
      }
    }, {
        ...
        if (add) {
          ...
          for (var _i = 0, _k = Object.keys(sources).length; _i < _k; _i++) {
            ...
            try {
              ...
              this.emit(MSE_EVENTS$2.MSE_ERROR, this.TAG, new Error(e.message));
            }
          }
  ...
  var AudioTrack = function (_Track) {
     ...
     */
    function AudioTrack() {
      _classCallCheck$6(this, AudioTrack);
  ...
  var VideoTrack = function (_Track2) {
     ...
     */
    function VideoTrack() {
      _classCallCheck$6(this, VideoTrack);
  ...
  var Tracks = function () {
    function Tracks() {
      _classCallCheck$6(this, Tracks);

      this.audioTrack = null;
      this.videoTrack = null;
    }

    _createClass$6(Tracks, [{
      key: 'destroy',
      value: function destroy() {
        this.audioTrack = null;
        this.videoTrack = null;
  ...
  var PreSource = function () {
    function PreSource() {
      _classCallCheck$7(this, PreSource);

      this.sources = {};
    }

    _createClass$7(PreSource, [{
      key: 'getSource',
  ...
  var XgBuffer = function () {
    ...
    function XgBuffer(length) {
      _classCallCheck$8(this, XgBuffer);
  ...
  var ADTS = function () {
    function ADTS() {
      _classCallCheck$9(this, ADTS);
    }

    _createClass$9(ADTS, null, [{
      key: "isHeader",
  ...
  var AAC = function () {
    function AAC() {
      _classCallCheck$a(this, AAC);
    }

    _createClass$a(AAC, null, [{
      key: 'getSilentFrame',
  ...
  var PageVisibility = function () {
    function PageVisibility() {
      _classCallCheck$b(this, PageVisibility);
  ...
  var MediaInfo$1 = function () {
    function MediaInfo() {
      _classCallCheck$c(this, MediaInfo);
  ...
  var Context$1 = function () {
    function Context() {
      ...
      _classCallCheck$d(this, Context);
    ...
    _createClass$d(Context, [{
      ...
      value: function registry(tag, cls) {
        ...
        var enhanced = function (_cls) {
          ...
          function enhanced(a, b, c) {
            _classCallCheck$d(this, enhanced);
  ...
  var MediaSample = function () {
    function MediaSample(info) {
      ...
      _classCallCheck$e(this, MediaSample);
    ...
    _createClass$e(MediaSample, null, [{
      key: 'getDefaultInf',
  ...
  var MediaSegment = function () {
      function MediaSegment() {
          _classCallCheck$f(this, MediaSegment);
  ...
  var MediaSegmentList = function () {
    function MediaSegmentList(type) {
      _classCallCheck$g(this, MediaSegmentList);
    ...
    _createClass$g(MediaSegmentList, [{
      key: "isEmpty",
  ...
  var Compatibility = function () {
    function Compatibility() {
      _classCallCheck$h(this, Compatibility);
      ...
      value: function doFixAudio(first, streamChangeStart) {
        ...
        if (this.nextAudioDts) {
          ...
          if (gap >= iRefSampleDuration && gap < 100 * iRefSampleDuration) {
            ...
            this.emit(REMUX_EVENTS$2.DETECT_AUDIO_GAP, gap, silentFrameCount);
            ...
            this.emit(REMUX_EVENTS$2.DETECT_AUDIO_OVERLAP, gap);
          }
        }
  ...
  var Buffer = function () {
    function Buffer(buffer) {
      _classCallCheck$i(this, Buffer);

      this.buffer = buffer || new Uint8Array(0);
    }

    _createClass$i(Buffer, [{
      key: 'write',
  ...
  var Fmp4 = function () {
    function Fmp4() {
      _classCallCheck$j(this, Fmp4);
    }

    _createClass$j(Fmp4, null, [{
      key: 'size',
  ...
  var Mp4Remuxer = function () {
    function Mp4Remuxer() {
      ...
      _classCallCheck$k(this, Mp4Remuxer);
    ...
    _createClass$k(Mp4Remuxer, [{
      ...
      value: function _remuxVideo(videoTrack) {
        ...
        while (samples.length && maxLoop-- > 0) {
          ...
          if (isKeyframe) {
            this.emit(REMUX_EVENTS$3.RANDOM_ACCESS_POINT, pts);
          }
        }
        ...
        this.emit(REMUX_EVENTS$3.MEDIA_SEGMENT, 'video');
      ...
      value: function _remuxAudio(track) {
        ...
        this.emit(REMUX_EVENTS$3.MEDIA_SEGMENT, 'audio', moofMdat);
  ...
  var M3U8Parser = function () {
    function M3U8Parser() {
      _classCallCheck$l(this, M3U8Parser);
    }

    _createClass$l(M3U8Parser, null, [{
      key: 'parse',
  ...
  var SPSParser = function () {
    function SPSParser() {
      _classCallCheck$o(this, SPSParser);
    }

    _createClass$o(SPSParser, null, [{
      key: '_ebsp2rbsp',
  ...
  var RBSP = function () {
    function RBSP() {
      _classCallCheck$p(this, RBSP);
    }

    _createClass$p(RBSP, null, [{
      key: "EBSP2RBSP",
  ...
  var SEIParser = function () {
    function SEIParser() {
      _classCallCheck$q(this, SEIParser);
    }

    _createClass$q(SEIParser, null, [{
      key: '_resolveNalu',
  ...
  var Nalunit = function () {
    function Nalunit() {
      _classCallCheck$r(this, Nalunit);
    }

    _createClass$r(Nalunit, null, [{
      key: 'getNalunits',
  ...
  var SPSParser$1 = function () {
    function SPSParser() {
      _classCallCheck$t(this, SPSParser);
    }

    _createClass$t(SPSParser, null, [{
      key: '_ebsp2rbsp',
      value: function _ebsp2rbsp(uint8array) {
        var src = uint8array;
        var srcLength = src.byteLength;
  ...
  var RBSP$1 = function () {
    function RBSP() {
      _classCallCheck$u(this, RBSP);
    }

    _createClass$u(RBSP, null, [{
      key: "EBSP2RBSP",
  ...
  var SEIParser$1 = function () {
    function SEIParser() {
      _classCallCheck$v(this, SEIParser);
    }

    _createClass$v(SEIParser, null, [{
      key: '_resolveNalu',
      value: function _resolveNalu(data) {
        if (data.length >= 1) {
  ...
  var Nalunit$1 = function () {
    function Nalunit() {
      _classCallCheck$w(this, Nalunit);
    }

    _createClass$w(Nalunit, null, [{
      key: 'getNalunits',
      value: function getNalunits(buffer) {
        if (buffer.length - buffer.position < 4) {
          return [];
  ...
  var AudioTrackMeta = function () {
    function AudioTrackMeta(meta) {
      _classCallCheck$x(this, AudioTrackMeta);
  ...
  var VideoTrackMeta = function () {
    function VideoTrackMeta(meta) {
      _classCallCheck$x(this, VideoTrackMeta);
  ...
  var AudioTrackSample = function () {
    function AudioTrackSample(info) {
      _classCallCheck$y(this, AudioTrackSample);
    ...
    _createClass$y(AudioTrackSample, null, [{
      key: "getDefault",
  ...
  var VideoTrackSample = function () {
    function VideoTrackSample(info) {
      _classCallCheck$y(this, VideoTrackSample);
    ...
    _createClass$y(VideoTrackSample, null, [{
      key: "getDefault",
      value: function getDefault() {
        return {
          dts: null,
  ...
  var TsDemuxer = function () {
    function TsDemuxer(configs) {
      _classCallCheck$z(this, TsDemuxer);
    ...
    _createClass$z(TsDemuxer, [{
      ...
      value: function demux(frag) {
        ...
        Promise.resolve().then(function () {
          ...
          while (buffer.length >= 188) {
            if (buffer.length >= 1 && buffer.array[0][buffer.offset] !== 71) {
              _this.emit(DEMUX_EVENTS$2.DEMUX_ERROR, _this.TAG, new Error('Untrust sync code: ' + buffer.array[0][buffer.offset] + ', try to recover;'), false);
            }
        ...
        setTimeout(function () {
          if (_this._hasAudioMeta) {
            _this.emit(DEMUX_EVENTS$2.DEMUX_COMPLETE, 'audio');
          }
          if (_this._hasVideoMeta) {
            _this.emit(DEMUX_EVENTS$2.DEMUX_COMPLETE, 'video');
          }
        });
      }
    }, {
      ...
      value: function pushVideoSample(pes, options) {
        ...
        if (sei) {
          sei.dts = dts;
          this.emit(DEMUX_EVENTS$2.SEI_PARSED, sei);
        }
      ...
      value: function compaireMeta(a, b, ignoreDuration) {
        ...
        for (var i = 0, k = Object.keys(a).length; i < k; i++) {
          ...
          if ((typeof itema === 'undefined' ? 'undefined' : _typeof$4(itema)) !== 'object') {
  ...
  var Playlist = function () {
    function Playlist(configs) {
      _classCallCheck$A(this, Playlist);
        ...
        return new Promise(function (resolve) {
          if (_this4.__core__ && _this4.__core__.mse) {
            _this4.__core__.mse.destroy().then(function () {
              ...
              _get$2(HlsLivePlayer.prototype.__proto__ || Object.getPrototypeOf(HlsLivePlayer.prototype), 'destroy', _this4).call(_this4);
              setTimeout(function () {
                resolve();
              }, 50);
            });
  ...
  var RBSP$2 = function () {
    function RBSP() {
      _classCallCheck$E(this, RBSP);
    }

    _createClass$E(RBSP, null, [{
      key: "EBSP2RBSP",
  ...
  var SEIParser$2 = function () {
    function SEIParser() {
      _classCallCheck$F(this, SEIParser);
    }

    _createClass$F(SEIParser, null, [{
      key: '_resolveNalu',
      value: function _resolveNalu(data) {
        if (data.length >= 1) {
  ...
  var Nalunit$2 = function () {
    function Nalunit() {
      _classCallCheck$G(this, Nalunit);
    }

    _createClass$G(Nalunit, null, [{
      key: 'getNalunits',
      value: function getNalunits(buffer) {
        if (buffer.length - buffer.position < 4) {
          return [];
      ...
      value: function analyseNal(unit) {
        ...
        switch (type) {
          ...
          case 6:
            // SEI
            unit.sei = SEIParser$2.parse(unit.body);
            break;
          case 7:
            // SPS
  ...
  var u8aToString$3 = function u8aToString(data) {
    var result = '';
    for (var i = 0; i < data.byteLength; i++) {
      result += String.fromCharCode(data[i]);
    }
  ...
  var SEIParser$3 = function () {
    ...
    _createClass$K(SEIParser, null, [{
      ...
      value: function user_data_unregistered(data) {
        ...
        var uuid = u8aToString$3(payload.slice(0, 16));
        var content = u8aToString$3(payload.slice(16, payloadLength));
    ...
    _createClass$L(Nalunit, null, [{
      ...
      value: function analyseNal(unit) {
        ...
        switch (type) {
          ...
          case 33:
            // SPS
            unit.sps = SPSParser$3.parseSPS(unit.body);
            break;
          case 34:
            // PPS
            unit.pps = true;
          ...
          case 39:
            // PREFIX_SEI
            // unit.prefix_sei = true;
            unit.sei = SEIParser$3.parse(unit.body.slice(1));
            break;
          case 40:
            // SUFFIX_SEI
            unit.sei = SEIParser$3.parse(unit.body.slice(1));
  ...
  var HlsLiveController$1 = function () {
    function HlsLiveController(configs) {
      _classCallCheck$M(this, HlsLiveController);
    ...
    _createClass$M(HlsLiveController, [{
      key: 'init',
      value: function init() {
        var _player$hlsOps = this._player.hlsOps,
            XgBuffer = _player$hlsOps.XgBuffer,
      ...
      key: 'initEvents',
      value: function initEvents() {
        this.on(LOADER_EVENTS$3.LOADER_COMPLETE, this._onLoadComplete.bind(this));
      ...
      value: function _onError(type, mod, err, fatal) {
        ...
        this._player.emit(HLS_ERROR$1, error);
      }
    }, {
      key: '_onDemuxComplete',
      value: function _onDemuxComplete() {
      ...
      value: function _onLoadError(loader, error) {
        if (!this._tsloader.loading && !this._m3u8loader.loading && this.retrytimes > 1) {
          this.retrytimes--;
          this._onError(LOADER_EVENTS$3.LOADER_ERROR, loader, error, false);
        } else if (this.retrytimes <= 1) {
          this._onError(LOADER_EVENTS$3.LOADER_ERROR, loader, error, true);
      ...
      value: function _onLoadComplete(buffer) {
        if (buffer.TAG === 'M3U8_BUFFER') {
          ...
          this.retrytimes = this.configs.retrytimes || 3;
          this._playlist.downloaded(this._tsloader.url, true);
          this.emitTo('CRYPTO', CRYTO_EVENTS$3.START_DECRYPT);
        } else if (buffer.TAG === 'KEY_BUFFER') {
      ...
      value: function destroy() {
        clearInterval(this._timmer);
        this.off(LOADER_EVENTS$3.LOADER_COMPLETE, this._onLoadComplete);
        // this.off(REMUX_EVENTS.REMUX_ERROR);
  ...
  var HlsLivePlayer$1 = function (_Player) {
    _inherits$4(HlsLivePlayer, _Player);

    _createClass$N(HlsLivePlayer, null, [{
      key: 'isSupported',
      value: function isSupported() {
    ...
    function HlsLivePlayer(options) {
      _classCallCheck$N(this, HlsLivePlayer);
      ...
      var _this = _possibleConstructorReturn$4(this, (HlsLivePlayer.__proto__ || Object.getPrototypeOf(HlsLivePlayer)).call(this, options));
    ...
    _createClass$N(HlsLivePlayer, [{
      ...
      value: function start() {
        ...
        this.url = url;
        this.__core__.load(url);
        _get$3(HlsLivePlayer.prototype.__proto__ || Object.getPrototypeOf(HlsLivePlayer.prototype), 'start', this).call(this, url);
        this._initEvents();
        this.started = true;
      }
    }, {
      ...
      value: function play() {
        ...
        _get$3(HlsLivePlayer.prototype.__proto__ || Object.getPrototypeOf(HlsLivePlayer.prototype), 'play', this).call(this);
      }
    }, {
      key: 'destroy',
      value: function destroy() {
        ...
        return new Promise(function (resolve) {
          _get$3(HlsLivePlayer.prototype.__proto__ || Object.getPrototypeOf(HlsLivePlayer.prototype), 'destroy', _this3).call(_this3);
          var video = _this3.video,
              root = _this3.root;

          _get$3(HlsLivePlayer.prototype.__proto__ || Object.getPrototypeOf(HlsLivePlayer.prototype), 'destroy', _this3).call(_this3, isDelDOM);
  ...
  var HlsLivePlayer$2 = function () {
    function HlsLivePlayer$2(config) {
      _classCallCheck$O(this, HlsLivePlayer$2);

      if (HlsLivePlayer$1.isSupported() && config.useWASM) {
        return new HlsLivePlayer$1(config);
      }if (HlsLivePlayer.isSupported()) {
    ...
    _createClass$O(HlsLivePlayer$2, null, [{
      key: 'install',
      value: function install(name, plugin) {
        return Player.install(name, plugin);
      }
    ...
    return HlsLivePlayer$2;
  }();

  HlsLivePlayer$2.EVENTS = EVENTS;
  ...
  var CRYTO_EVENTS$4 = EVENTS.CRYTO_EVENTS;
  ...
  var HlsVodController = function () {
    function HlsVodController(configs) {
      _classCallCheck$P(this, HlsVodController);
    ...
    _createClass$P(HlsVodController, [{
      key: 'init',
      value: function init() {
        // 初始化Buffer （M3U8/TS/Playlist);
        this._context.registry('M3U8_BUFFER', XgBuffer);
      ...
      key: 'initEvents',
      value: function initEvents() {
        this.on(LOADER_EVENTS$4.LOADER_COMPLETE, this._onLoaderCompete.bind(this));

        this.on(LOADER_EVENTS$4.LOADER_ERROR, this._onLoadError.bind(this));
        ...
        this.on(DEMUX_EVENTS$4.METADATA_PARSED, this._onMetadataParsed.bind(this));

        this.on(DEMUX_EVENTS$4.DEMUX_COMPLETE, this._onDemuxComplete.bind(this));

        this.on(DEMUX_EVENTS$4.DEMUX_ERROR, this._onDemuxError.bind(this));
        ...
        this.on(MSE_EVENTS$3.SOURCE_UPDATE_END, this._onUpdateEnd.bind(this));

        this.on('TIME_UPDATE', this._onTimeUpdate.bind(this));

        this.on(MSE_EVENTS$3.SOURCE_UPDATE_END, this._onTimeUpdate.bind(this));
      ...
      value: function _onError(type, mod, err, fatal) {
        ...
        this._player && this._player.emit(HLS_ERROR$2, error);
      }
    }, {
      key: '_onLoadError',
      value: function _onLoadError(mod, error) {
        ...
        this._onError(LOADER_EVENTS$4.LOADER_ERROR, mod, error, true);
      ...
      value: function _onDemuxError(mod, error, fatal) {
        ...
        this._onError(LOADER_EVENTS$4.LOADER_ERROR, mod, error, fatal);
      }
    }, {
      key: '_onRemuxError',
      value: function _onRemuxError(mod, error, fatal) {
      ...
      value: function _onLoaderCompete(buffer) {
        if (buffer.TAG === 'M3U8_BUFFER') {
          ...
          if (this._playlist.encrypt && this._playlist.encrypt.uri && !this._playlist.encrypt.key) {
            ...
            this._tsloader.buffer = 'DECRYPT_BUFFER';
            this._keyLoader = this._context.registry('KEY_LOADER', FetchLoader)({ buffer: 'KEY_BUFFER', readtype: 3 });
            this.emitTo('KEY_LOADER', LOADER_EVENTS$4.LADER_START, this._playlist.encrypt.uri);
          } else {
            if (!this.preloadTime) {
            ...
            if (frag) {
              this._playlist.downloading(frag.url, true);
              this.emitTo('TS_LOADER', LOADER_EVENTS$4.LADER_START, frag.url);
            } else {
              if (this.retrytimes > 0) {
                this.retrytimes--;
                this.emitTo('M3U8_LOADER', LOADER_EVENTS$4.LADER_START, this.url);
              }
            }
          }
        } else if (buffer.TAG === 'TS_BUFFER') {
          ...
          this.retrytimes = this.configs.retrytimes || 3;
          this._playlist.downloaded(this._tsloader.url, true);
          this.emitTo('CRYPTO', CRYTO_EVENTS$4.START_DECRYPT, Object.assign({ url: this._tsloader.url }, this._playlist._ts[this._tsloader.url]));
        } else if (buffer.TAG === 'KEY_BUFFER') {
          this.retrytimes = this.configs.retrytimes || 3;
          this._playlist.encrypt.key = buffer.shift();
          this._crypto = this._context.registry('CRYPTO', Crypto)({
          ...
          this._crypto.on(CRYTO_EVENTS$4.DECRYPTED, this._onDcripted.bind(this));

          var _frag = this._playlist.getTs();
          if (_frag) {
            this._playlist.downloading(_frag.url, true);
            this.emitTo('TS_LOADER', LOADER_EVENTS$4.LADER_START, _frag.url);
          } else {
            if (this.retrytimes > 0) {
              this.retrytimes--;
              this.emitTo('M3U8_LOADER', LOADER_EVENTS$4.LADER_START, this.url);
      ...
      key: '_onDcripted',
      value: function _onDcripted() {
        this.emit(DEMUX_EVENTS$4.DEMUX_START);
      }
    }, {
      key: 'seek',
      value: function seek(time) {
      ...
      value: function load(url) {
        ...
        this.url = url;
        this.emitTo('M3U8_LOADER', LOADER_EVENTS$4.LADER_START, url);
      }
    }, {
      key: '_preload',
      value: function _preload(time) {
        ...
        if (currentbufferend < 0) {
          ...
          if (_frag2 && !_frag2.downloading && !_frag2.downloaded) {
            ...
            this.emitTo('TS_LOADER', LOADER_EVENTS$4.LADER_START, _frag2.url);
          }
        }
      }
    }, {
      ...
      value: function destory() {
        ...
        this.off(LOADER_EVENTS$4.LOADER_COMPLETE, this._onLoaderCompete);

        this.off(REMUX_EVENTS$5.INIT_SEGMENT, this._onInitSegment);

        this.off(REMUX_EVENTS$5.MEDIA_SEGMENT, this._onMediaSegment);

        this.off(DEMUX_EVENTS$4.METADATA_PARSED, this._onMetadataParsed);

        this.off(DEMUX_EVENTS$4.DEMUX_COMPLETE, this._onDemuxComplete);
  ...
  var HlsAllowedEvents$3 = EVENTS.HlsAllowedEvents;
  var REMUX_EVENTS$6 = EVENTS.REMUX_EVENTS;
  var HLS_EVENTS$3 = EVENTS.HLS_EVENTS;
  var MSE_EVENTS$4 = EVENTS.MSE_EVENTS;

  var HlsVodPlayer = function (_Player) {
    _inherits$5(HlsVodPlayer, _Player);

    function HlsVodPlayer(options) {
      _classCallCheck$Q(this, HlsVodPlayer);

      var _this = _possibleConstructorReturn$5(this, (HlsVodPlayer.__proto__ || Object.getPrototypeOf(HlsVodPlayer)).call(this, options));
    ...
    _createClass$Q(HlsVodPlayer, [{
      ...
      value: function _initEvents() {
        ...
        this.__core__.once(REMUX_EVENTS$6.INIT_SEGMENT, function () {
          ...
          _get$4(HlsVodPlayer.prototype.__proto__ || Object.getPrototypeOf(HlsVodPlayer.prototype), 'start', _this3).call(_this3, mse.url);
        });
        ...
        this.__core__.on(MSE_EVENTS$4.SOURCE_UPDATE_END, function () {
      ...
      value: function start() {
        ...
        if (!this._context) {
          this._context = new Context(HlsAllowedEvents$3);
        }
      ...
      value: function swithURL(url) {
        this.config.url = url;
        var context = new Context(HlsAllowedEvents$3);
      ...
      value: function destroy() {
        ...
        return new Promise(function (resolve) {
          if (_this5.__core__ && _this5.__core__.mse) {
            _this5.__core__.mse.destroy().then(function () {
              if (_this5._context) {
                _this5._context.destroy();
              }
              _get$4(HlsVodPlayer.prototype.__proto__ || Object.getPrototypeOf(HlsVodPlayer.prototype), 'destroy', _this5).call(_this5);
              resolve();
            });
            setTimeout(function () {
              resolve();
      ...
      key: 'currentTime',
      get: function get() {
        return _get$4(HlsVodPlayer.prototype.__proto__ || Object.getPrototypeOf(HlsVodPlayer.prototype), 'currentTime', this);
      },
  ...
  var HlsPlayer = function () {
    function HlsPlayer(config) {
      _classCallCheck$R(this, HlsPlayer);
