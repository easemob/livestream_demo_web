(function (global, factory) {
  ...
  var MediaInfo$1 = function () {
    function MediaInfo() {
      _classCallCheck$2(this, MediaInfo);
  ...
  var Context$1 = function () {
    function Context() {
      ...
      _classCallCheck$3(this, Context);
    ...
    _createClass$3(Context, [{
      ...
      value: function registry(tag, cls) {
        ...
        var enhanced = function (_cls) {
          ...
          function enhanced(a, b, c) {
            _classCallCheck$3(this, enhanced);
  ...
  var MediaSample = function () {
    function MediaSample(info) {
      ...
      _classCallCheck$4(this, MediaSample);
    ...
    _createClass$4(MediaSample, null, [{
      key: 'getDefaultInf',
  ...
  var MediaSegment = function () {
      function MediaSegment() {
          _classCallCheck$5(this, MediaSegment);
  ...
  var MediaSegmentList = function () {
    function MediaSegmentList(type) {
      _classCallCheck$6(this, MediaSegmentList);
    ...
    _createClass$6(MediaSegmentList, [{
      key: "isEmpty",
  ...
  var AudioTrack = function (_Track) {
    ...
    function AudioTrack() {
      ...
      var _this = _possibleConstructorReturn$2(this, (AudioTrack.__proto__ || Object.getPrototypeOf(AudioTrack)).call(this));
  ...
  var VideoTrack = function (_Track2) {
    _inherits$2(VideoTrack, _Track2);
    ...
    function VideoTrack() {
      ...
      var _this2 = _possibleConstructorReturn$2(this, (VideoTrack.__proto__ || Object.getPrototypeOf(VideoTrack)).call(this));
  ...
  var PreSource = function () {
    function PreSource() {
      _classCallCheck$9(this, PreSource);

      this.sources = {};
    }

    _createClass$9(PreSource, [{
      key: 'getSource',
    ...
    _createClass$b(FetchLoader, [{
      ...
      value: function getParams(opts) {
        ...
        var params = {
          ...
          // add custmor headers
          // 添加自定义头
        };if (_typeof$3(this.configs.headers) === 'object') {
        ...
        if (_typeof$3(options.headers) === 'object') {
  ...
  var ADTS = function () {
    function ADTS() {
      _classCallCheck$c(this, ADTS);
    }

    _createClass$c(ADTS, null, [{
      key: "isHeader",
  ...
  var Buffer = function () {
    function Buffer(buffer) {
      _classCallCheck$g(this, Buffer);

      this.buffer = buffer || new Uint8Array(0);
    }

    _createClass$g(Buffer, [{
      key: 'write',
  ...
  var Fmp4 = function () {
    function Fmp4() {
      _classCallCheck$h(this, Fmp4);
    }

    _createClass$h(Fmp4, null, [{
      key: 'size',
  ...
  var Mp4Remuxer = function () {
    function Mp4Remuxer() {
      ...
      _classCallCheck$i(this, Mp4Remuxer);
  ...
  var M3U8Parser = function () {
    function M3U8Parser() {
      _classCallCheck$k(this, M3U8Parser);
    }

    _createClass$k(M3U8Parser, null, [{
      key: 'parse',
  ...
  var SPSParser$1 = function () {
    function SPSParser() {
      _classCallCheck$s(this, SPSParser);
    }

    _createClass$s(SPSParser, null, [{
      key: '_ebsp2rbsp',
      value: function _ebsp2rbsp(uint8array) {
        var src = uint8array;
        var srcLength = src.byteLength;
  ...
  var RBSP$1 = function () {
    function RBSP() {
      _classCallCheck$t(this, RBSP);
    }

    _createClass$t(RBSP, null, [{
      key: "EBSP2RBSP",
  ...
  var SEIParser$1 = function () {
    function SEIParser() {
      _classCallCheck$u(this, SEIParser);
    }

    _createClass$u(SEIParser, null, [{
      key: '_resolveNalu',
      value: function _resolveNalu(data) {
        if (data.length >= 1) {
  ...
  var Nalunit$1 = function () {
    function Nalunit() {
      _classCallCheck$v(this, Nalunit);
    }

    _createClass$v(Nalunit, null, [{
      key: 'getNalunits',
      value: function getNalunits(buffer) {
        if (buffer.length - buffer.position < 4) {
          return [];
  ...
  var AudioTrackMeta = function () {
    function AudioTrackMeta(meta) {
      _classCallCheck$w(this, AudioTrackMeta);
  ...
  var VideoTrackMeta = function () {
    function VideoTrackMeta(meta) {
      _classCallCheck$w(this, VideoTrackMeta);
  ...
  var AudioTrackSample = function () {
    function AudioTrackSample(info) {
      _classCallCheck$x(this, AudioTrackSample);
    ...
    _createClass$x(AudioTrackSample, null, [{
      key: "getDefault",
  ...
  var VideoTrackSample = function () {
    function VideoTrackSample(info) {
      _classCallCheck$x(this, VideoTrackSample);
    ...
    _createClass$x(VideoTrackSample, null, [{
      key: "getDefault",
      value: function getDefault() {
        return {
          dts: null,
  ...
  var TsDemuxer = function () {
    function TsDemuxer(configs) {
      _classCallCheck$y(this, TsDemuxer);
  ...
  var Playlist = function () {
    function Playlist(configs) {
      _classCallCheck$z(this, Playlist);
  ...
  var HlsVodController = function () {
    ...
    _createClass$A(HlsVodController, [{
      ...
      value: function initEvents() {
        this.on(LOADER_EVENTS$2.LOADER_COMPLETE, this._onLoaderCompete.bind(this));
        ...
        this.on(MSE_EVENTS$2.SOURCE_UPDATE_END, this._onUpdateEnd.bind(this));

        this.on('TIME_UPDATE', this._onTimeUpdate.bind(this));

        this.on(MSE_EVENTS$2.SOURCE_UPDATE_END, this._onTimeUpdate.bind(this));
      ...
      value: function _onLoadError(mod, error) {
        ...
        this._onError(LOADER_EVENTS$2.LOADER_ERROR, mod, error, true);
      ...
      value: function _onLoaderCompete(buffer) {
        if (buffer.TAG === 'M3U8_BUFFER') {
          ...
          this.retrytimes = this.configs.retrytimes || 3;
          this._playlist.downloaded(this._tsloader.url, true);
          this.emitTo('CRYPTO', CRYTO_EVENTS$2.START_DECRYPT, Object.assign({ url: this._tsloader.url }, this._playlist._ts[this._tsloader.url]));
          ...
          if (_frag) {
            ...
            this.emitTo('TS_LOADER', LOADER_EVENTS$2.LADER_START, _frag.url);
          } else {
            if (this.retrytimes > 0) {
              this.retrytimes--;
              this.emitTo('M3U8_LOADER', LOADER_EVENTS$2.LADER_START, this.url);
      ...
      value: function load(url) {
        ...
        this.url = url;
        this.emitTo('M3U8_LOADER', LOADER_EVENTS$2.LADER_START, url);
      }
    }, {
      key: '_preload',
      ...
      value: function destory() {
        ...
        this.off(LOADER_EVENTS$2.LOADER_COMPLETE, this._onLoaderCompete);

        this.off(REMUX_EVENTS$3.INIT_SEGMENT, this._onInitSegment);

        this.off(REMUX_EVENTS$3.MEDIA_SEGMENT, this._onMediaSegment);
  ...
  var HlsVodPlayer = function (_Player) {
    ...
    _createClass$B(HlsVodPlayer, [{
      ...
      value: function _initEvents() {
        ...
        this.__core__.once(HLS_EVENTS$1.RETRY_TIME_EXCEEDED, function () {
          _this3.emit('error', new Player.Errors('network', _this3.config.url));
        });

        this.__core__.on(MSE_EVENTS$3.SOURCE_UPDATE_END, function () {
